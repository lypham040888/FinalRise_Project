...
public class CommonActions {
	...
	public void click(Object locator,WebDriver driver) {
	...
	public void selectByText(WebElement element,WebDriver driver) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		//WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.visibilityOf(element));
		element.click();
	...
	public void selectByIndex(WebElement element,WebDriver driver) {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		//WebDriverWait wait = new WebDriverWait(driver, 10);
		wait.until(ExpectedConditions.visibilityOf(element));
		element.click();
...
//	}
	...
	public void inputTextJavaScriptInnerHTML(By inputElement, String companyName,WebDriver driver) {
		...
		try {
			...
			pause(1000);
			inputTextJavaScriptInnerHTML(inputElement, companyName, driver);
		}
	}

	public void inputTextJavaScriptValue(By locator, String value,WebDriver driver ) {
		WebElement element = getElementPresentDOM(locator, driver);
		try {
			((JavascriptExecutor) driver).executeScript("arguments[0].value = '" + value + "'", element);
		} catch (StaleElementReferenceException ex) {
			pause(1000);
			inputTextJavaScriptValue(locator, value, driver);
		}
	}
	...
	public void scrollToElement(By locator,WebDriver driver) {
		WebElement element = getElementPresentDOM(locator, driver);
		((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", element);
	}

	public WebElement getElementPresentDOM(By locator,WebDriver driver) {
	...
	public boolean isElementPresent(By locator,WebDriver driver) {
		...
		//WebDriverWait wait = new WebDriverWait(driver, initWaitTime);
		wait.until(ExpectedConditions.visibilityOf(getElementPresentDOM(locator, driver)));
		return getElementPresentDOM(locator, driver).isDisplayed();
	}
